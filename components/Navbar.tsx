...
export default function Navbar() {
  ...
  function toggleMobileMenu(label: string) {
    setMobileMenu((current) => (current === label ? null : label));
  }
  ...
  return (
    <>
      ...
      >
        {/* Utility Bar */}
        <div className="hidden bg-[#123d2a] text-white lg:block">
          ...
          <div className="flex h-[78px] items-center justify-between">
            ...
            <div className="ml-auto hidden items-center xl:flex">
              <nav className="flex items-center">
                <Link
                  href="/"
                  className="px-3 py-7 text-[13px] font-semibold text-[#168044]"
                >
                  Home
                </Link>

                {menus.map((menu) => {
                  const hasDropdown = !!menu.items?.length;
                  ...
                  if (!hasDropdown) {
                    return (
                      <Link
                        key={menu.label}
                        href={menu.href || "#"}
                        className="px-3 py-7 text-[13px] font-semibold text-neutral-700 transition hover:text-[#168044]"
                      >
                        {menu.label}
                      </Link>
                    );
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className={`flex items-center gap-1 px-3 py-7 text-[13px] font-semibold transition ${
                          activeMenu === menu.label
                            ? "text-[#168044]"
                            : "text-neutral-700 hover:text-[#168044]"
                        }`}
                      >
                        {menu.label}
              ...
              <div className="ml-3 flex items-center gap-2 border-l border-neutral-200 pl-4">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center text-neutral-600 transition hover:text-[#168044]"
                  aria-label="Search"
                >
                  <Search size={19} />
                </button>
                ...
                <Link
                  href="#membership"
                  className="flex h-11 items-center gap-2 bg-taha-dark px-5 text-[13px] font-bold text-white transition hover:bg-[#126b39]"
                >
                  Join TAHA
                  <ArrowRight size={16} />
                </Link>
            ...
            <div className="flex items-center gap-2 xl:hidden">
              <button
                type="button"
                onClick={() => setSearchOpen((current) => !current)}
                className="flex h-10 w-10 items-center justify-center text-neutral-700 transition hover:text-[#168044]"
                aria-label="Search"
              >
                <Search size={20} />
              </button>
            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  className="h-14 w-full border border-neutral-300 pl-12 pr-5 text-sm text-neutral-800 outline-none transition placeholder:text-neutral-400 focus:border-[#168044] focus:ring-1 focus:ring-[#168044]"
                />
              </div>
            </form>
          </div>
        ...
        {activeMenu && (
          <div
            ...
            className="absolute left-0 right-0 top-full border-t border-neutral-100 bg-white shadow-[0_15px_40px_rgba(0,0,0,0.10)]"
          >
            <div className="mx-auto max-w-[1400px] px-6 py-8">
              {(() => {
                const menu = menus.find((item) => item.label === activeMenu);
                ...
                return (
                  ...
                  >
                    <div>
                        ...
                        {menu.items?.map((item) => (
                          ...
                          >
                            <div className="flex items-center justify-between gap-3">
                              <div>
                                <div className="text-[14px] font-semibold text-neutral-800 transition group-hover:text-[#168044]">
                                  {item.title}
                                </div>
                              ...
                              <ArrowRight
                                size={15}
                                className="shrink-0 text-neutral-300 transition group-hover:translate-x-1 group-hover:text-[#168044]"
                              />
                            </div>
                          </Link>
                        ))}
                      ...
                      <div className="mt-6">
                        <Link
                          href="#"
                          onClick={closeNavigation}
                          className="inline-flex items-center gap-2 text-sm font-semibold text-[#168044] transition hover:text-[#123d2a]"
                        >
                    ...
                    {menu.featured && (
                      <div className="self-start bg-[#eef7f1] p-7">
                        <div className="text-xs font-bold uppercase tracking-[0.15em] text-[#168044]">
                          Featured
                        </div>

                        <h3 className="mt-4 text-2xl font-bold text-[#123d2a]">
                          {menu.featured.title}
                        </h3>
                        ...
                        <Link
                          ...
                          onClick={closeNavigation}
                          className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-[#168044] transition hover:text-[#126b39]"
                        >
                          Explore
                          <ArrowRight size={16} />
                        </Link>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-[100] xl:hidden">
          ...
          <div className="absolute bottom-0 right-0 top-0 w-[min(420px,92vw)] overflow-y-auto bg-white shadow-2xl">
            {/* Mobile Header */}
            <div className="flex h-[78px] items-center justify-between border-b border-neutral-200 px-6">
              ...
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#168044]">
                  <span className="font-bold text-white">T</span>
                </div>

                <span className="font-bold text-[#123d2a]">TAHA</span>
              </Link>
            ...
            <div className="p-6">
              <Link
                href="/"
                onClick={closeNavigation}
                className="block border-b border-neutral-200 py-4 font-semibold text-[#168044]"
              >
                Home
              </Link>
              ...
              {menus.map((menu) => {
                ...
                if (!hasItems) {
                  return (
                    <Link
                      ...
                      href={menu.href || "#"}
                      onClick={closeNavigation}
                      className="block border-b border-neutral-200 py-4 font-semibold text-neutral-800 transition hover:text-[#168044]"
                    >
                      {menu.label}
                    </Link>
                  );
                ...
                const open = mobileMenu === menu.label;

                return (
                  <div key={menu.label} className="border-b border-neutral-200">
                    <button
                      type="button"
                      ...
                      <div className="pb-3 pl-3">
                        {menu.items?.map((item) => (
                          <Link
                            ...
                            href={item.href}
                            onClick={closeNavigation}
                            className="flex items-center justify-between py-3 text-sm text-neutral-600 transition hover:text-[#168044]"
                          >
              ...
              <div className="pt-6">
                <Link
                  href="#membership"
                  onClick={closeNavigation}
                  className="flex items-center justify-center gap-2 bg-[#168044] py-4 font-bold text-white transition hover:bg-[#126b39]"
                >
                  Join TAHA
                  <ArrowRight size={17} />
                </Link>
              ...
              <div className="mt-8 border-t border-neutral-200 pt-6">
                ...
                <a
                  href="mailto:info@taha.or.tz"
                  className="mt-4 flex items-center gap-2 text-sm text-neutral-600 transition hover:text-[#168044]"
                >
                  <Mail size={16} />
                  info@taha.or.tz
                </a>
                ...
                <div className="mt-6 flex gap-5 text-sm font-semibold text-neutral-500">
                  <a href="#" className="transition hover:text-[#168044]">
                    Facebook
                  </a>
